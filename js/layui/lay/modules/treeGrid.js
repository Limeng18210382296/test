    ...
    var $ = layui.$
        ...
        ,TPL_HEADER = function(options){
            ...
            return ['<table cellspacing="0" cellpadding="0" border="0" class="layui-table" '
                ...
                ,'<th class="{{ item2.hide ? "layui-hide":"" }}" data-field="{{ item2.field||i2 }}" {{# if(item2.minWidth){ }}data-minwidth="{{item2.minWidth}}"{{# } }} '+ rowCols +' {{# if(item2.unresize){ }}data-unresize="true"{{# } }}>'
                    ...
                    that.eachCols(function(i3, item3){
                        ...
                        var td = ['<td data-field="'+ field +'" '+ function(){
                            ...
                            if(item3.minWidth) attr.push('data-minwidth="'+ item3.minWidth +'"'); //单元格最小宽度
														if(item3.hide) attr.push('class="layui-hide"'); //单元格隐藏列
                            return attr.join(' ');
                        }() +'>'
